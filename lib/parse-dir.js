...
class FileProcessor {
  ...
  determineIfDirectory(done, results) {
  ...
  parseFileContents(done, results) {
  ...
  processFile(file, callback) {
    ...
    async.auto({
      ...
      isDirectory: ['meta', 'async_', this.determineIfDirectory],
      fileContents: ['isDirectory', this.getFileContents],
      parsedContents: ['fileContents', this.parseFileContents]
    },
    (err, results) => {
