...
test('should handle multiple files', (t) => {
  t.plan(2);
...
test('should return relative paths', (t) => {
  t.plan(3);
...
test('should return isDirectory', (t) => {
  t.plan(2);
...
test('should return parsed = false for unknown files', (t) => {
  t.plan(1);
...
test('should return raw == contents if not parsed', (t) => {
  t.plan(1);
  parseDir('test/fixture/unknown/**/*', (err, data) => {
